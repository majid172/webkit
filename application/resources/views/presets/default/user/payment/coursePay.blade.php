            ...
            <div class="shadow p-3 mb-5 bg-body rounded">
                <form action="{{route('user.deposit.insert')}}" method="post">
                    ...
                    <div class="text-primary custom--card">
                        <h5 class="card-title">@lang('Course Purchase')</h5>
                        <div class="mt-5 px-3">
                            <div class="form-group mb-3">
                                <label class="form-label">@lang('Select Gateway')</label>
                                <select class="form-control form--control" name="gateway" required>
                                    <option value="">@lang('Select One')</option>
                                    <option value="1">@lang('From Balance') - {{getAmount(auth()->user()->balance)}} {{$general->cur_text}}</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" step="any" name="amount" class="form-control form--control"
                                        value="{{ $amount }}" autocomplete="off" readonly>
                            ...
                            <button type="submit" class="btn btn-primary w-100 mt-3">@lang('Buy Now')</button>
                        </div>
                    </div>
                </form>
            </div>
