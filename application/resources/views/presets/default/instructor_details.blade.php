                        ...
                        <div class="course-item bg-light">
                            <div class="position-relative overflow-hidden">
                                ...
                                <div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
                                    <a href="" class="flex-shrink-0 btn btn-sm btn-primary px-3 border-end" style="border-radius: 30px 0 0 30px;">@lang('View More')</a>
                            ...
                            <div class="d-flex border-top">
                                ...
                                <small class="flex-fill text-center border-end py-2"><i class="fa fa-clock text-primary me-2"></i>@lang('Episode')  ss</small>
                                <small class="flex-fill text-center py-2"><i class="fa fa-user text-primary me-2"></i>@lang('Students') s</small>
                            </div>
                        </div>
                    </div>
