...
<div class="container-fluid p-0 mb-5">
    <div class="owl-carousel header-carousel position-relative">
        <div class="owl-carousel-item position-relative">
            <img class="img-fluid" src="{{getImage(getFilePath('frontend').'/banner/' .
            @$content_1->data_values->first_img)}}" alt="first_img" >
            <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(24, 29, 56, .7);">
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="col-sm-10 col-lg-8">
                            <h5 class="text-light text-uppercase mb-3 animated slideInDown">{{__
                            ($content_1->data_values->subheading1)}}</h5>
        ...
        <div class="owl-carousel-item position-relative">
            <img class="img-fluid" src="{{getImage(getFilePath('frontend').'/banner/' .
            @$content_1->data_values->second_img)}}" alt="second_img" >
            <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(24, 29, 56, .7);">
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="col-sm-10 col-lg-8">
                            <h5 class="text-light text-uppercase mb-3 animated slideInDown">Best Online Courses{{__
                            ($content_1->data_values->subheading2)}}</h5>
