            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                    <a href="{{route('user.course.list')}}" class="nav-link text-primary" data-toggle="tooltip" data-placement="right" title="Courses">
                        <i class="las la-book-reader me-1 fs-4"></i>@lang('Course List')
                    </a>
                </li>
                ...
                <li class="list-group-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item text-primary" href="{{route('user.withdraw')}}"><i class="las la-wallet me-2 fs-5"></i>@lang('Payout Money')</a>
                        <a class="dropdown-item text-primary" href="{{route('user.withdraw.history')}}"><i class="las la-history me-2 fs-5 "></i>@lang('Payout History')</a>
