        ...
        <div class="login__body ">
            ...
            <form class="form" action="{{ route('admin.password.verify.code') }}" method="POST">
                ...
                <div class="form-row">
                    ...
                    <div class="verification-code text-secondary">
                ...
                <div class="field">
                    <button type="submit" class="sign-in bg--primary"><span class="fas fa-arrow-right"
                                                                            aria-hidden="true"></span>@lang('Verify')</button>
                </div>
            </form>
        </div>
    </div>
